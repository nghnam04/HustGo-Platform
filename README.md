...
| **Quản trị bưu cục** | - Xem báo cáo thống kê bưu cục<br>- Xác nhận nhận đơn / nhập kho trung chuyển<br>- Tạo tuyến trung chuyển<br>- Tạo tuyến giao hàng<br>- Gán tuyến cho shipper<br>- Quản lý đơn hàng chờ giao<br>- Tương tác với Chatbot |
| **Quản trị hệ thống** | - Xem báo cáo tổng quan hệ thống<br>- Quản lý người dùng<br>- Quản lý bưu cục<br>- Quản lý phản hồi<br>- Tương tác với Chatbot |
